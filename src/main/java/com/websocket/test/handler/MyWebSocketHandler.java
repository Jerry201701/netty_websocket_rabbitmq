...
public class MyWebSocketHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
   // @Autowired
  //  private ChannelRedisService redisService;
    @Autowired
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
      ...
      //      id="token";
            ...
            //redisTemplate.opsForValue().set(id,channelId);

          ///  RedisUtil redisUtil=new RedisUtil();
          //  redisUtil.set(id,channelId);
           // redisService.addChannelId(id,channelId);
           // redisUtil.set(id,channelId);
           ...
           // sendAllMessage(frame.text());
            ...
            TextWebSocketFrame tws = new TextWebSocketFrame(frame.text());
            //发送到独有的管道
    ...
    private void sendSpecific(MsgVo msgVo){
